		...
		<div class="content">
			...
			<div class="section-address">
				...
				<div class="address-body">
					<ul>
						<li :class="item.id == confirmAddress ? 'in-section' : ''"
				...
				<div class="goods-list">
					<ul>
						<li v-for="item in getCheckGoods" :key="item.id">
							...
							<span class="pro-price">{{ item.price }}元 x
								{{ item.num }}</span>
							<span class="pro-status"></span>
							<span class="pro-total">{{ item.price *
								item.num }}元</span>
						</li>
					</ul>
				</div>
				...
				<div class="money-box">
					<ul>
						...
						<li class="total">
							...
							<span class="value">
								<span
									class="total-price">{{ getTotalPrice }}</span>元
							</span>
						</li>
					</ul>
				</div>
			...
			<div class="section-bar">
				<div class="btn">
					<router-link to="/shoppingCart"
						class="btn-base btn-return">返回购物车</router-link>
					<a href="javascript:void(0);" @click="addOrder"
						class="btn-base btn-primary">结算</a>
				</div>
			</div>
			<!-- 结算导航END -->
		</div>
