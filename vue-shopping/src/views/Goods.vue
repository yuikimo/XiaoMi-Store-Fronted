			...
			<div class="product-nav">
				...
				<el-tabs v-model="activeName" type="card">
					<el-tab-pane v-for="item in categoryList"
						:key="item.categoryId" :label="item.categoryName"
...
export default {
	...
	methods: {
		...
		currentChange(currentPage) {
			...
			if (this.search != "") {
				this.getProductBySearch(this.currentPage);
			} else {
				this.getData();
			}
			this.backtop();
		...
		// 通过搜索条件向后端请求商品数据 todo
		async getProductBySearch(search_currentPage) {

			const api = "api/product/getProductBySearch/" +
				search_currentPage + "/" +
				this.pageSize + "/" + this.search
